...
public class TacticsUIMenu : MonoBehaviour
{

    public static TacticsUIMenu instance;
    ...
    public void SwichLeadboards()
    {
        ...
        Leaderboard.Instance.SwapLeaderboardsTactics();
        if (Leaderboard.Instance.isOnlineTactics)
        {
